...
const AnimatedStat = ({ value, label }) => {
  ...
  return (
    <motion.div
      ref={ref}
      className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg border border-orange-100 dark:border-gray-600 hover:shadow-xl transition-shadow"
      initial="hidden"
      animate={controls}
      variants={cardVariants}
      whileHover={{ y: -5 }}
    >
      <div className="text-4xl font-bold text-orange-500 dark:text-amber-400 mb-2">
  ...
  return (
    <>
      ...
      <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 overflow-hidden">
        ...
        {/* Hero Section */}
        <section className="relative bg-gradient-to-r from-orange-100 to-yellow-50 dark:from-gray-800 dark:to-gray-700 py-24 px-6 text-center overflow-hidden">
          <motion.div 
            className="absolute -top-20 -right-20 w-64 h-64 bg-orange-200 dark:bg-amber-900 rounded-full filter blur-3xl opacity-30 dark:opacity-20"
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 0.3 }}
            transition={{ duration: 2, repeat: Infinity, repeatType: "reverse" }}
          />
          <motion.div 
            className="absolute -bottom-10 -left-10 w-56 h-56 bg-amber-200 dark:bg-orange-900 rounded-full filter blur-3xl opacity-30 dark:opacity-20"
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 0.3 }}
          ...
          <div className="relative z-10">
            <motion.h1
              className="text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-amber-600 dark:from-amber-400 dark:to-orange-400"
              initial="hidden"
              animate="visible"
              variants={fadeInUp}
            >
            ...
            <motion.p
              className="text-lg md:text-xl max-w-2xl mx-auto mb-8 text-gray-700 dark:text-gray-300"
              initial="hidden"
              animate="visible"
            ...
            <motion.div 
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button className="bg-gradient-to-r from-orange-500 to-amber-500 dark:from-amber-600 dark:to-orange-600 text-white hover:from-orange-600 hover:to-amber-600 dark:hover:from-amber-700 dark:hover:to-orange-700 px-8 py-3 rounded-full shadow-lg">
                Visit Us
              </Button>
            </motion.div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
          <div className="max-w-7xl mx-auto px-4">
            <motion.h2
              className="text-4xl font-bold text-center text-orange-600 dark:text-amber-400 mb-16"
              initial="hidden"
              whileInView="visible"
              ...
              {[
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-orange-500 dark:text-amber-400 font-medium mb-3">{item.desc}</p>
                    <span className="inline-block px-3 py-1 bg-amber-100 dark:bg-amber-900/50 text-amber-800 dark:text-amber-200 rounded-full text-sm font-medium">
                      Customer Favorite
                    </span>
                  </div>
                </motion.div>
        ...
        <section className="py-20 bg-white dark:bg-gray-900">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <motion.h2
              className="text-4xl font-bold text-orange-600 dark:text-amber-400 mb-12"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-100px" }}
              variants={fadeInUp}
            >
              The <span className="text-amber-500 dark:text-amber-300">People&rsquo;s Choice</span> Choice
            </motion.h2>
            <motion.div
              className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-gray-800 dark:to-gray-700 p-1 rounded-3xl shadow-2xl"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-100px" }}
              variants={scaleUp}
            >
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl">
                ...
                <h3 className="text-3xl font-bold text-orange-700 dark:text-amber-400 mb-3">Special Chai</h3>
                ...
                <div className="mt-6">
                  <span className="inline-flex items-center px-4 py-2 bg-orange-100 dark:bg-amber-900/50 text-orange-700 dark:text-amber-200 rounded-full">
                    <span className="relative flex h-3 w-3 mr-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-orange-400 dark:bg-amber-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-3 w-3 bg-orange-500 dark:bg-amber-500"></span>
                    </span>
                    #1 Best Seller
                  </span>
                </div>
        ...
        <section className="py-20 bg-white dark:bg-gray-900">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <motion.h2
              ...
              variants={fadeInUp}
            >
              Voices of <span className="text-orange-500 dark:text-amber-400">Delight</span>
            </motion.h2>
            <motion.div
              className="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-3xl shadow-lg border border-orange-100 dark:border-gray-600"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-100px" }}
              variants={scaleUp}
